...
- **次セッションの申し送り（優先順）**:
  ...
  3. ✅ **sim05（ナポ/アリアン移行＋追撃較正）計画策定済み（2026-07-22・`simulation/sim05/README.md`・実行未着手）**: 読み順は sim05/README §0。依存チェーン G0〜G5＝コード整備（ナポ押し順cands.s・アリアン条件付き+1）→configC→追撃C3/C5 fit→override/golden戦略。**着手ゲート=§6 Q（Q1 アビ番号↔キー確定＝ユーザー所感「2アビ≥10」vs pike≥15 の矛盾・Q2 boss・Q3 configC・Q4 golden戦略案A/B・Q5 短縮ソース）**。intake（編成/実機ATK/HP/所感）は `simulation/napoleon_arian_migration/README.md`。
