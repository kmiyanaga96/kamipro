...
- **次セッションの申し送り（優先順）**:
  ...
  3. **アリアンロッド登録較正の残作業（sim04と並行可）**: 第1回（2026-07-17）で A1〜A7/A9 実機確定済み。記録は `gamedata/md/神姫/arianrhod.md` §3（旧 ARIANROD_REGISTRATION.md を 2026-07-19 統合・原本はgit履歴）。残＝A8（急所倍率・アリアン入り統計的較正に相乗り）・**絶対値fit（sim04後）**・§1.2とA0のバースト係数矛盾（5.5/3000 vs 実機転記5.0/2500）の再確認。
