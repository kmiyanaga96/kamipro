...
const SUMMON_REGISTRY = {
  ...
  //   加護の原文は「装備中のスキル[レイ][シャイン][ルミナ][セイクリッド]の効果量50%UP」だが、
  //     **この4名は光属性スキルの接頭辞＝光属性スキルの総称**（ユーザー回答 2026-08-07）＝
  //     `applyGear` の一律適用で正しい（**C50 closed**）。⚠ **非光属性ウェポンを装備したら誤りになる**
  //     （現在は WEAPON_MASTER の全7本が light）＝他属性編成を作るならスキル属性のゲートが要る。
