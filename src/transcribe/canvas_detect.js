...
export const DEFAULTS = {
  ...
  /**
   * 想定アスペクト比とその許容幅。
   * ★実測値（2026-08-14・T1 v0.1.0 が実フレームで検出）: **1.4916**
   *   測定条件＝2288×1440 / Microsoft Game DVR / Chrome ブラウザ版 / 検出 box 1684×1129。
   *   ⚠ **1本の録画からの1点測定**。別の録画・別のウィンドウサイズでは未再測（REPO_STANDARDS E1/E9）。
