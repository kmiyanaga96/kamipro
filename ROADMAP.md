...
> [!NOTE]
> **現状（2026-06）**: Phase 2（エンジン汎用化）完了。Phase 3 は実測に基づき「ホットパス最適化」を主軸に補正済み（`PHASE3_PLAN.md`）。
> 本書の §2.1 が言及する「基本アクションのVM化（Phase 3）」は、`PHASE3_PLAN.md` §2.3 の**将来選択肢**へ位置づけ変更された（ホットパス最適化を先行）。
